      ...
      <div className="flex size-full items-center justify-center">
        <div className="size-[1920px] shrink-0 scale-50 sm:scale-75 lg:scale-100">
          <div
            ...
            className="relative top-96 right-[50%] grid size-full origin-top-left grid-cols-8 gap-4 transform-3d"
          >
                ...
                {subarray.map((image, imageIndex) => (
                  <div className="relative" key={imageIndex + image}>
                    ...
                    <motion.img
                      ...
                      // Changed aspect ratio to 2:3 for movie posters (typical poster ratio)
